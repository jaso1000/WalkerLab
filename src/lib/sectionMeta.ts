...
export const SECTION_META: Record<SectionId, SectionMeta> = {
  ...
  music: { icon: 'musical-notes', tint: colors.lidarr, href: '/music', activePrefixes: ['/artist'] },
  ...
  transmission: { icon: 'repeat', tint: colors.transmission, href: '/transmission' },
  spin: { icon: 'shuffle', tint: colors.spin, href: '/spin' },
